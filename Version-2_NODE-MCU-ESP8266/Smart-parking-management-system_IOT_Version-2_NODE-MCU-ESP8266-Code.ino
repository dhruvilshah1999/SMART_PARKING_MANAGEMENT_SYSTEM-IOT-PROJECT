...
#define FIREBASE_HOST "spms-a85b2.firebaseio.com"                 // the project name address from firebase id
#define FIREBASE_AUTH "HzMb........................HKXVjmRBz"            // the secret key generated from firebase

#define WIFI_SSID "JAINI_EXT_EXT_EXT"                                             // input your home or public wifi name 
#define WIFI_PASSWORD "passwordjaini111"                                    //password for Wifi

String Available = "";                                                  //availability string
String fireAvailable = "";
String fireNotAvailable = "Full";
...
void loop() {
  ...
  if (carEntry == HIGH) {                     // if high then count and send data
    if (Empty == 0) {
      Firebase.pushString("Parking Status : ", fireNotAvailable);
